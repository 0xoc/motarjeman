...
function ae_private_message_default_option( $default ){
    $default = wp_parse_args( array( 'ae_private_message_mail_template'=> '<p>سلام [display_name]</p><p>شما پیام جدیدی از [from_user] بر روی [blogname] دریافت کرده اید.<p>پیام: [private_message]</p>شما می توانید بوسیله این لینک آن را ببینید: [message_link]</p>'), $default);
    return $default;
}
