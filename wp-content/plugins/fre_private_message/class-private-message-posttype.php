...
class AE_Private_Message_Posttype extends AE_Posts
{
    ...
    public  function ae_register_post_type_private_message(){
        ...
        $labels = array(
            'name' =>'پیام خصوصی',
            'singular_name' => 'پیام خصوصی' ,
            'add_new' => 'افزودن پیام خصوصی جدید' ,
            'add_new_item' => 'افزودن پیام خصوصی جدید' ,
            'edit_item' => 'ویرایش پیام خصوصی' ,
            'new_item' => 'پیام خصوصی جدید' ,
            'view_item' => 'مشاهده پیام خصوصی' ,
            'search_items' => 'جستجوی پیام خصوصی' ,
            'not_found' => 'پیام خصوصی یافت نشد' ,
            'not_found_in_trash' => 'پیام خصوصی در سطل زباله یافت نشد' ,
            'parent_item_colon' => 'والد پیام خصوصی:' ,
            'menu_name' => 'پیام خصوصی' ,
        );
//        $labels = array(
