...
class FRE_Credit_Withdraw extends AE_Posts
{
    ...
    public function  fre_credit_register_post_type(){
        ...
        register_post_type('fre_credit_withdraw', array(
            ...
            'labels' => array(
                'name' => 'تسویه حساب' ,
                'singular_name' => 'تسویه حساب' ,
                'add_new' => 'افزودن' ,
                'add_new_item' =>'افزودن تسویه حساب جدید' ,
                'edit_item' => 'ویرایش تسویه حساب' ,
                'new_item' => 'تسویه حساب جدید' ,
                'all_items' => 'همه تسویه حساب ها' ,
                'view_item' => 'مشاهده تسویه حساب ها' ,
                'search_items' => 'جستجوی تسویه حساب ها' ,
                'not_found' => 'تسویه حسابی یافت نشد' ,
                'not_found_in_trash' => 'تسویه حسابی در سطل زباله یافت نشد' ,
                'parent_item_colon' => '',
                'menu_name' => 'تسویه حساب' ,
            ) ,
//            'labels' => array(
