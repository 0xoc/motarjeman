    ...
    function fre_credit_template_payToSubmitProject_button(){
      ...
      ?>
        <li class="panel fre-credit-payment-onsite">
          ...
          <a data-toggle="collapse" data-type="frecredit" data-parent="#fre-payment-accordion" href="#fre-payment-frecredit" class="probtnsabt btn collapsed other-payment"><?php _e("Select", ET_DOMAIN); ?></a>
                                    ...
                                    <div class="credit-balance-wrap">
                                        <div class="credit-recharge">
                                            ...
                                            <div class="credit-recharge-btn-wrap">
                                                <a class="probtnsabt fre-normal-btn-o" href="<?php echo fre_credit_deposit_page_link() ?>"><?php _e('Deposit',ET_DOMAIN) ?></a>
                                            </div>
                                        </div>
...
<!--                                                 <div class="fre-table-row">
                                            ...
                                            <div class="credit-withdraw-btn-wrap <?php echo ((float)$minimum > $available->balance) ? 'not-money': ''; ?>">
		                                        ...
		                                        <?php else:?>
                                                    <a href="javascript:void(0)" class="probtnsabt fre-normal-btn-o btn-withdraw btn-withdraw-action"><?php _e('Withdraw', ET_DOMAIN); ?></a>
		                                        <?php endif;?>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                <div class="fre-input-field fre-period-field">
                                                    ...
                                                    <div class="period-min-wrap">
                                                        ...
                                                        <input class="fieldechange filter-period-min" id="fre_credit_from" type="text" placeholder="از">    <!-- mene77  fieldechange -->
                                                    </div>
                                                    <span>-</span>
                                                    <div class="period-max-wrap">
                                                        
                                                        <input class="fieldechange filter-period-max" id="fre_credit_to" type="text" placeholder="تا">    <!-- mene77  fieldechange -->
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="modal-body">
                        <form id="fre_credit_edit_paypal_form" class="fre-modal-form">
                            <div class="fre-input-field no-margin-bottom">
                                ...
                                <input type="text" class="fieldechange" id="email_paypal" name="email_paypal" placeholder="">   <!-- mene77  fieldechange -->
                            </div>
                            <div class="fre-form-btn">
                    ...
                    <div class="modal-body">
                        <form id="fre_credit_updat_bank_form" class="fre-modal-form">
                          <div class="fre-input-field">
                              ...
                              <input type="text" class="fieldechange form-control" id="benficial_owner" name="benficial_owner" >   <!-- mene77  fieldechange -->
                          </div>
                          <div class="fre-input-field">
                              <label class="fre-field-title" for="account_number"><?php _e('Account Number', ET_DOMAIN) ?></label>
                              <input type="text" class="fieldechange form-control" id="account_number" name="account_number">    <!-- mene77  fieldechange -->
                          </div>
                          <div class="fre-input-field no-margin-bottom">
                              <label class="fre-field-title" for="banking_information"><?php _e('Banking Information', ET_DOMAIN) ?></label>
                              <textarea class="fieldechange" id="banking_information" name="banking_information"></textarea>  <!-- mene77  fieldechange -->
                          </div>
                          <?php /*if(ae_get_option('fre_credit_secure_code', true)): */?><!--
                          ...
                          <div class="fre-form-btn">
                                ...
                                <span class="fre-form-close" data-dismiss="modal">انصراف</span>
                            </div>
                        </form>
                    </div>
                </div>
