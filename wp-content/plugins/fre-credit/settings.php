    ...
    function fre_credit_menu_credit( $pages ){
        ...
        $section = array(
            ...
            'groups' => array(
                ...
                array(
                    'args' => array(
                        'title' => __("Custom Charge", ET_DOMAIN) ,
                        'id' => 'custom-charge',
                        'class' => '',
                        'desc' => __("Enabling this will allow users insert Custom charge credit system on site.", ET_DOMAIN)
                    ) ,
                    'fields' => array(
                        array(
                            'id' => 'custom_charge',
...
function fre_credit_default_email($mail_template){
    ...
    $mail_template['fre_credit_deposit_mail_template'] = "<p>سلام,</p>
                                    <p>کاربر [display_name] مبلغ [number] در سایت شما سپرده کرد,لطفا پرداخت را بررسی و تایید نمایید</p>
                                    <p>با احترام,</p>
                                    <p>[blogname]</p>";

    $mail_template['fre_credit_request_secure_mail_template'] = "<p>سلام [display_name],</p>
                                    <p>شما درخواست رمز جدیدی نموده اید</p>
                                    <p>شما می توانید از این کد برای انتقال اعتبار استفاده کنید.و حتما در نگهداری این کد کوشا باشید</p>
                                    <p>کد شما: [code]</p>
                                    <p>با احترام,</p>
                                    <p>[blogname]</p>";


    $mail_template['fre_credit_withdraw_mail_template'] = "<p>سلام,</p>
                                    <p>درخواست تسویه حسابی برای سایت شما ارسال شده است</p>
                                    <p>نام: [display_name]</p>
                                    <p>مبلغ: [amount]</p>
                                    <p>پیام: [message]</p>
                                    <p>با احترام,</p>
                                    <p>[blogname]</p>";
    ...
    $mail_template['fre_credit_deposit_mail_template_buyer)'] = '<p>[display_name] عزیز,</p>
                                        <p>
                                            از پرداخت شما سپاسگذاریم<br />
                                            جزییات تراکنش شما:<br />
                                            <strong>جزییات</strong>: خرید بسته [package_name] . این بسته شامل [number_credit] اعتبار است.
                                        </p>
                                        <p>
