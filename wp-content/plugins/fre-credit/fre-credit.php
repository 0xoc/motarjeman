...
Description: سیستم اعتبار را به فریلنس انجین اضافه خواهد نمود
Version: 1.2.2
...
function fre_credit_enqueue_scripts(){
    ...
    wp_enqueue_style('fre_credit_persian_Datepicker_css', plugin_dir_url(__FILE__) . 'assets/DatePicker/css/persianDatepicker-default.css', array(), '1.0');
    wp_enqueue_script('fre_credit_persian_Datepicker_js', plugin_dir_url(__FILE__) . 'assets/DatePicker/js/persianDatepicker.min.js', array('jquery'), '1.0', true);
