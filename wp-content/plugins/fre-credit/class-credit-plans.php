...
class FRE_Credit_Plan_Posttype extends AE_Posts
{
    ...
    public function  fre_credit_register_post_type(){
        ...
        register_post_type('fre_credit_plan', array(
            ...
            'labels' => array(
                'name' => 'بسته اعتبار' ,
                'singular_name' => 'بسته اعتبار' ,
                'add_new' => 'افزودن' ,
                'add_new_item' => 'افزودن بسته اعتبار جدید' ,
                'edit_item' => 'ویرایش بسته اعتبار' ,
                'new_item' => 'بسته اعتبار جدید' ,
                'all_items' => 'همه بسته اعتبارها' ,
                'view_item' => 'مشاهده بسته اعتبار' ,
                'search_items' => 'جستجوی بسته اعتبارها' ,
                'not_found' => 'هیچ بسته اعتباری یافت نشد' ,
                'not_found_in_trash' => 'هیچ بسته اعتباری در سطل زباله یافت نشد' ,
                'parent_item_colon' => '',
                'menu_name' => 'بسته اعتبار' ,
            ) ,
//            'labels' => array(
...
//            ) ,
        ...
        $package = new AE_Pack('fre_credit_plan',array(
            ...
            array(
                'backend_text' => array(
                    'text' => __('%s  برای %s اعتبار', ET_DOMAIN) , //change by morteza
                    'data' => array(
                        'et_price',
                        'et_number_posts'
                    )
