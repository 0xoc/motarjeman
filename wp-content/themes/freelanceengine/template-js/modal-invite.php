			...
			<div class="modal-body">
				...
				<form role="form" class="fre-modal-form" id="submit_invite">
					...
					<div class="fre-form-btn">
						<button type="submit" class="probtnsabt fre-normal-btn btn-submit" <?php if($wp_query->found_posts == 0){echo 'disabled="disabled"';} ?> >
				...
				<?php }else { ?>
					<form role="form" class="fre-modal-form">
						<div class="invite-no-project">
							...
							<div class="fre-form-btn">
								<?php echo '<a class="probtnsabt fre-normal-btn" href="'.et_get_page_link('submit-project').'" >'.__("Post Project", ET_DOMAIN).'</a>'; ?>
		                        <span class="fre-form-close" data-dismiss="modal"><?php _e('Cancel', ET_DOMAIN) ?></span>
		                    </div>
						</div>
	                </form>
