            ...
            <div class="modal-body">
                <form role="form" id="bid_form" class="bid-form fre-modal-form">
                    <div class="fre-input-field">
                        <label class="fre-field-title" for="bid_budget"><?php _e( 'Your Bid', ET_DOMAIN ); ?><span class="star-for-require">&nbsp *</span></label> <!-- mene77 -->
                        ...
                        <div class="input-group">
                            <input type="number" name="bid_budget" id="bid_budget"
                                   class="fieldechange form-control number numberVal" min="0"/> <!-- mene77  fieldechange -->
                            <span class="input-group-addon"><?php echo fre_currency_sign(false); ?></span>
                        </div>
                    ...
                    <div class="fre-input-field">
                        <label class="fre-field-title" for="bid_time"><?php _e( 'Delivery', ET_DOMAIN ); ?><span class="star-for-require">&nbsp *</span></label>    <!-- mene77 -->
                        <div class="row">
                            <div class="col-md-9 col-sm-8 col-xs-6">
                                <input type="number" name="bid_time" id="bid_time" class="fieldechange form-control number numberVal" min="1"/>   <!-- mene77  fieldechange -->
                            </div>
                    ...
                    <!-- fa_v1.8.6.2 -->
	                <?php do_action( 'before_bid_form' ); ?>
                    <div class="fre-input-field no-margin-bottom">
                        <label class="fre-field-title"  for="post_content"><?php _e( 'Add Notes', ET_DOMAIN ); ?><span class="star-for-require">&nbsp *</span></label>   <!-- mene77 -->
