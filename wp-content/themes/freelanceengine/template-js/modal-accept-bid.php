...
<script type="text/template" id="bid-info-template">
    <!-- fa_v1.8.6.2 -->
	<?php  do_action('fre_before_accept_bid_infor'); ?>
	<p>
		<?php _e( 'You are about to accept this bid for' , ET_DOMAIN ); ?> <strong>{{=total}}</strong>
		<?php _e( 'This bid acceptance requires the payment below' , ET_DOMAIN ); ?>  <!--  mene77  -->
	</p>
	...
	<# if(accept_bid){ #>
		<div class="fre-form-btn">
			<button type="submit" class="probtnsabt fre-normal-btn">
	...
	<# }else{ #>
		<div class="fre-form-btn">
			<a target="_blank" class="probtnsabt fre-normal-btn btn-buy-credit" href="#"><?php _e("Buy credit", ET_DOMAIN);?></a>         <!-- mene77 -->
