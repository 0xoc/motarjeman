...
$myavatar = 'https://noorando.com/wp-content/uploads/2018/07/Avatar.png';
...
class ET_FreelanceEngine extends AE_Base {
	...
	function on_add_styles() {
        ...
        if(is_rtl()){
            // theme custom.css
            $this->add_style( 'main-style', get_template_directory_uri() . '/assets/css/styles-rtl.css', ET_VERSION );
            // theme custom.css
            $this->add_style( 'custom', get_template_directory_uri() . '/css/custom-rtl.css', ET_VERSION );
            $this->add_style( 'scroll-bar', get_template_directory_uri() . '/assets/css/jquery.mCustomScrollbar-rtl.css', ET_VERSION );
        }else{
            // theme custom.css
...
function get_list_jalali_month_name_option($select)
{
    $months = array(
        1 => 'فروردین',
        2 => 'اردیبهشت',
    ...
    foreach ($months as $key => $month_name) {
        ...
        ! empty( $select ) && $select == $key ? $selected = 'selected' : $selected = '';
...
function get_list_jalali_year_name_option($select)
{
    $year=ztjalali_english_num(jdate( 'Y', time()));
    for ( $i = $year; $i >= intval( $year ) - 50; $i -- ) {
        ! empty( $select ) && $select == $i ? $selected = 'selected' : $selected = '';
 ...
 * @param $jalali_date
 * @return string
 * 1397/01/01 -> 2018/3/21
 */
function jalali_to_gregorian_for_filter_credit($jalali_date){

    $jdata=explode('/',$jalali_date);
    $j_y=$jdata[0];
    $j_m=$jdata[1];
    $j_d=$jdata[2];
 ...
 * add by morteza
 * add new mail theme
 * add new theme for header email
 */

add_filter( 'ae_get_mail_header', 'cs_custom_header_email' );
function cs_custom_header_email(){
    $url = home_url();
    $header_hml = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
...
<body style="font-family: Tahoma, Helvetica, sans-serif; box-sizing: border-box; background-color: #f5f8fa; color: #74787e; height: 100%; hyphens: auto; line-height: 1.4; margin: 0; -moz-hyphens: auto; -ms-word-break: break-all; width: 100% !important; -webkit-hyphens: auto; -webkit-text-size-adjust: none; word-break: break-word; direction: rtl" dir="rtl">
<style>
...
<table class="wrapper" width="100%" cellpadding="0" cellspacing="0"
       style="font-family: Tahoma, Helvetica, sans-serif; box-sizing: border-box; background-color: #f5f8fa; margin: 0; padding: 0; width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%;">
    <tr>
        <td align="center" style="font-family: Tahoma, Helvetica, sans-serif; box-sizing: border-box;">
            <table class="content" width="100%" cellpadding="0" cellspacing="0"
                   style="font-family: Tahoma, Helvetica, sans-serif; box-sizing: border-box; margin: 0; padding: 0; width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%;">
                <tr>
                    <td class="header"
                        style="font-family: Tahoma, Helvetica, sans-serif; box-sizing: border-box; padding: 25px 0; text-align: center;">
                        <a href="'.esc_url( $url ).'"
                           style="font-family: Tahoma, Helvetica, sans-serif; box-sizing: border-box; color: #bbbfc3; font-size: 19px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 #ffffff;">
                            ' . get_option( 'blogname' ) . '
                        </a>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="body" width="100%" cellpadding="0" cellspacing="0"
                        style="font-family: Tahoma, Helvetica, sans-serif; box-sizing: border-box; background-color: #ffffff; border-bottom: 1px solid #edeff2; border-top: 1px solid #edeff2; margin: 0; padding: 0; width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%;">
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                               style="font-family: Tahoma, Helvetica, sans-serif; box-sizing: border-box; background-color: #ffffff; margin: 0 auto; padding: 0; width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px;">
                            <!-- Body content -->
                            <tr>
                                <td class="content-cell"
                                    style="font-family: Tahoma, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">';
    return $header_hml ;
}
 ...
 * add by morteza
 * add new mail theme
 * add new theme for footer email
 */
...
function cs_custom_mail_footer(){
    ...
    $footer_html= '</td>
                ...
                <tr>
                    <td style="font-family: Tahoma, Helvetica, sans-serif; box-sizing: border-box;">
                        <table class="footer" align="center" width="570" cellpadding="0" cellspacing="0"
                               style="font-family: Tahoma, Helvetica, sans-serif; box-sizing: border-box; margin: 0 auto; padding: 0; text-align: center; width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px;">
                            <tr>
                                <td class="content-cell" align="center"
                                    style="font-family: Tahoma, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                    <p style="font-family: Tahoma, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #aeaeae; font-size: 12px; text-align: center;">
                                        ' . $copyright . '</p>
                                        <p style="font-family: Tahoma, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #aeaeae; font-size: 12px; text-align: center;">
                                        ' . $info . '</p>
                                </td>
 ...
 * @param $role
 * add by morteza
 * use freelanceengine\includes\aecore\template\user-item.php
 * @return string
 */
function role_to_farsi($role){

    switch ($role){
        case 'Administrator': return 'مدیر';break;
        case 'Editor': return 'ویرایشگر';break;
        case 'Author': return 'نویسنده';break;
        case 'Contributor': return 'مشارکت کننده';break;
        case 'Freelancer': return 'فریلنسر';break;
        case 'Employer': return 'کارفرما';break;
        case 'Subscriber': return 'مشترک';break;
    }
}
