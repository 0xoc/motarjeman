...
<div class="fre-background" id="background_banner" style="background-image: url('<?php echo get_theme_mod("background_banner") ? get_theme_mod("background_banner") : get_template_directory_uri()."/img/fre-bg.png";?>');">
	<div class="fre-bg-content">
		<div class="container">
			...
			<div class="zirco">
				در نورَندو، چندین  <span style="color: #fcb3de;">مترجم و نویسنده  </span>آماده کار برای شما می‌باشند.
			...
			<?php if(!is_user_logged_in()){ ?>
				...
				<?php }else{ ?>
					<a class="fre-btn primary-bg-color" href="<?php echo et_get_page_link('projects'); ?>"><?php _e('Hire Freelancer', ET_DOMAIN);?></a>
					<a class="fre-btn primary-bg-color" href="<?php echo et_get_page_link('profiles'); ?>"><?php _e('Apply as Freelancer', ET_DOMAIN);?></a>
				<?php } ?>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="fre-work-block">
					...
					<p id="desc_work_4"><?php echo get_theme_mod("desc_work_4") ? get_theme_mod("desc_work_4") : __('With our protection, money is only paid for work you authorize', ET_DOMAIN);?></p>
								...
								<!--mene77-->
				<div class="Grouping" >
		<h1 class="h1-grouping">دسته‌بندی پروژه‌ها</h1>
	<div class="Group1">
		
		<a href="https://noorando.com/project_category/web-and-blog-writing/"><span  class="sp16group sp-group">
			<img class="imgg1 img-grouping" src="https://noorando.com/wp-content/uploads/2018/08/web-and-blog-writing.png"><div class="color-grouping">محتوا‌نویسی وب</div>
		</span></a>
		
		
		
		<a href="https://noorando.com/project_category/technical-writing/"><span  class="sp13group sp-group">
			<img class="img-grouping" src="https://noorando.com/wp-content/uploads/2018/08/technical-writing.png">			<div class="color-grouping">متون فنی</div></span></a>
		
		
			
		<a href="https://noorando.com/project_category/personal-writing/"><span  class="sp13group sp-group"><img class="img-grouping" src="https://noorando.com/wp-content/uploads/2018/08/personal-writing.png">			<div class="color-grouping">متون شخصی</div></span></a>
		...
		<div class="Group2">
					...
					<a 	href="https://noorando.com/project_category/editor-writing/"><span  class="sp15group sp-group"><img class="imgg2 img-grouping" src="https://noorando.com/wp-content/uploads/2018/08/editor-writing.png"><div class="color-grouping">ویرایش</div></span></a>
			
			
			
			<a href="https://noorando.com/project_category/translation/"><span class="sp17group sp-group">
			<img class="img-grouping" src="https://noorando.com/wp-content/uploads/2018/08/translation.png"><div class="color-grouping">ترجمه</div>
			</span></a>
			
			
			<a href="https://noorando.com/project_category/creative-writing/"><span class="sp13group sp-group"><img class="img-grouping" src="https://noorando.com/wp-content/uploads/2018/08/creative-writing.png"><div class="color-grouping">نوشتن خلاقانه</div></span></a>
		...
		<a 	href="https://noorando.com/project_category/business-writing/"><span class="spk-group sp14group sp-group"><img class="img-grouping2"  src="https://noorando.com/wp-content/uploads/2018/08/business-writing.png"><div class="color-grouping">کسب و کار</div></span></a>
			
			
			<a href="https://noorando.com/project_category/academic-writing/"><span class="sp13group sp-group"><img class="img-grouping" src="https://noorando.com/wp-content/uploads/2018/08/academic-writing.png"><div class="color-grouping">متون دانشگاهی</div></span></a>
						
			<a href="https://noorando.com/project_category/press/"><span class="sp17group sp-group"><img class="imgg3 img-grouping" src="https://noorando.com/wp-content/uploads/2018/08/press.png"><div class="color-grouping">متون خبری</div></span></a>
		...
		<div class="Group3">
							<a href="https://noorando.com/project_category/transcription/"><span class="sp14group sp-group"><img class="img-grouping" src="https://noorando.com/wp-content/uploads/2018/08/Transcription.png"><div class="color-grouping">رونویسی</div></span></a>
			
			
		<a href="https://noorando.com/project_category/legal-writing/"><span class="sp13group sp-group"><img class="img-grouping" src="https://noorando.com/wp-content/uploads/2018/08/legal-writing.png"><div 	class="color-grouping">نوشته حقوقی</div></span></a>
			
			
			
		<a 	href="https://noorando.com/project_category/other-writings/"><span class="sp13group sp-group"><img class="img-grouping" src="https://noorando.com/wp-content/uploads/2018/08/other-writings.png"><div class="color-grouping">متون متفرقه</div></span></a>
...
<div class="fre-perfect-freelancer">
	<div class="container">
		...
		<div class="fre-perfect-freelancer-more">
			<a class="probtnsabt fre-btn-o primary-color" href="<?php echo get_post_type_archive_link( PROFILE ); ?>"><?php _e('See all freelancers', ET_DOMAIN);?></a>
		</div>
	</div>
</div>
<!-- List Profiles -->
