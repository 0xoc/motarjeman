...
//$hire_freelancer = fre_count_hire_freelancer( $user_ID );    <!--  mene77  -->
                            ...
                            <div class="profile-<?php echo $class_name ?>-info">
                                ...
                                <div class="<?php echo $class_name ?>-info-content">
                                    <div class="<?php echo $class_name ?>-rating">
                                        ...
                                        <!--    <span> <?php printf(__('hire %s freelancers',ET_DOMAIN), intval($hire_freelancer) ); ?></span>   -->			<!--  mene77  -->
                                    ...
                                    if($author_id == get_current_user_id() || ae_user_role(get_current_user_id())=="administrator"){
									...
									echo '<div class="freelance-info-edit">';
										if( ae_user_role( $user_ID ) == EMPLOYER  || current_user_can('manage_options') ) { ?>
											<a href="#" data-toggle="modal"
	                                           class="probtnsabt fre-normal-btn primary-bg-color <?php if ( is_user_logged_in() ) {
												   echo 'invite-open';
											   } else {
												   echo 'login-btn';
