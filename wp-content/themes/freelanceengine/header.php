...
<header class="fre-header-wrapper">
    ...
    <div class="fre-header-wrap" id="main_header">
                ...
                <ul class="fre-menu-main">
					...
					<?php } else { ?>
						...
						<li class="fre-menu-employer dropdown">
							...
							<li>
									<div class="dsabtep">
										<a class="asabtep" href="<?php echo et_get_page_link( 'submit-project' ); ?>"><?php _e( 'Post a Project', ET_DOMAIN ); ?></a>
									</div>
								</li>
						<?php } ?>
					<?php } ?>
			...
			<?php if ( ! is_user_logged_in() ) { ?>
                <div class="fre-account-wrap">
                    <div class="fre-login-wrap">
                        <ul class="fre-login">
							<li>   <!-- mene77 -->
								<a class="chkmikonad" href="https://noorando.com/how-it-works/">
									چگونه کار می‌کند
								</a>   <!-- mene77 -->
							</li>
                            <li>
		...
		<!--/// mene77  ///-->
		<?php if($f=='/'  ||  $f== '/login/' || $f=='/register/' || $f=='/register/?role=employer' || $f=='/register/?role=freelancer'){
			/*  for home page  */
		} 
		else{ ?>
		...
		<div class="site-navigation-wrap">
			<nav class="site-navigation">
				<ul>
					...
					<li style="<?php echo $colornev1 ?>"><a href="https://noorando.com/project_category/web-and-blog-writing/">محتوا‌نویسی وب</a></li>
					<li style="<?php echo $colornev2 ?>"><a href="https://noorando.com/project_category/technical-writing/">متون فنی</a> </li>		
					<li style="<?php echo $colornev3 ?>"><a href="https://noorando.com/project_category/personal-writing/">متون شخصی</a></li>
					<li style="<?php echo $colornev4 ?>"><a href="https://noorando.com/project_category/editor-writing/">ویرایش</a></li>
					<li style="<?php echo $colornev5 ?>"><a href="https://noorando.com/project_category/translation/">ترجمه</a></li>
					<li style="<?php echo $colornev6 ?>"><a href="https://noorando.com/project_category/creative-writing/">نوشتن خلاقانه</a></li>
					<li style="<?php echo $colornev7 ?>;"><a href="https://noorando.com/project_category/business-writing/">کسب و کار</a></li>
					<li style="<?php echo $colornev8 ?>"><a href="https://noorando.com/project_category/academic-writing/">متون دانشگاهی</a></li>
					<li style="<?php echo $colornev9 ?>"><a href="https://noorando.com/project_category/press/">متون خبری</a></li>
					<li style="<?php echo $colornev10 ?>"><a href="https://noorando.com/project_category/transcription/">رونویسی</a></li>
					<li style="<?php echo $colornev11 ?>"><a href="https://noorando.com/project_category/legal-writing/">نوشته حقوقی</a></li>
					<li style="<?php echo $colornev12 ?>;border-left: 1px dashed #e6e6e6;"><a href="https://noorando.com/project_category/other-writings/">متون متفرقه</a></li>
				</ul>
			</nav>
		</div>
