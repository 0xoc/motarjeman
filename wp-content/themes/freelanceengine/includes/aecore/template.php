	...
	function ae_pagination( $query, $current = '', $type = 'page', $text = '' ) {
		...
		if ( $type === 'page' ) {
			...
			echo paginate_links( array(
				...
				'next_text' => __( 'next', ET_DOMAIN ) . ' <i class="fa fa-angle-left"></i>',//fa-angle-right to fa-angle-left by morteza
				'prev_text' => '<i class="fa fa-angle-right"></i> ' . __( 'prev', ET_DOMAIN ),//fa-angle-left to fa-angle-right by morteza
			) );
		} else {
			if ( $text == '' ) {
