...
//		'singular_name'         => _x( 'Country', 'Taxonomy singular name', ET_DOMAIN ),
		...
		'name'                  => 'کشور',//change by morteza
		'singular_name'         => 'کشور',//change by morteza
...
//		'add_new_item'       => __( 'Add New portfolio', ET_DOMAIN ),
        ...
        'add_new'            => 'افزودن نمونه کار جدید',//change by morteza
		'add_new_item'       => 'افزودن نمونه کار جدید',//change by morteza
...
//		'singular_name'         => _x( 'Skill', 'Taxonomy singular name', ET_DOMAIN ),
        ...
        'name'                  => 'مهارت',//change by morteza
		'singular_name'         => 'مهارت',//change by morteza
...
class Fre_ProfileAction extends AE_PostAction {
	...
	function sync_post() {
		...
		// add by morteza set phone when update profile
		do_action("insert_mobile_profile",$request);
