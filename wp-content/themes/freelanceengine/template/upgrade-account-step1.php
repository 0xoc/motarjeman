    ...
    <div class="fre-post-project-box">
        <div class="step-post-package">
            ...
            <div class="fre-select-package-btn">
                ...
                <input class="probtnsabt fre-btn fre-post-project-next-btn select-plan primary-bg-color" type="button" value="<?php _e('Next Step', ET_DOMAIN);?>">
            </div>
        </div>
    </div>
</div>
