                ...
                <div class="col-lg-4 col-md-5">
					...
					<?php if ( current_user_can( 'manage_options' ) && $post->post_status != 'disputed' ) { ?>
                        <div class="project-detail-action">
                            <a class="probtnsabt fre-normal-btn btn-arbitrate-project" id="<?php echo $project->ID ?>"
                        ...
                        <div class="conversation-disputed-typing">
                            <form class="form-report">
                                ...
                                <textarea name="comment_content"
                                    ...
                                    <input class="probtnsabt fre-normal-btn submit-chat-content" type="submit"
