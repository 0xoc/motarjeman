<?php
/*  wp-content/themes/freelanceengine/template/single-project-content.php */
...
<div class="project-detail-box no-padding">
    ...
    <div class="project-detail-extend">
        ...
        <div class="project-detail-about">
			...
			<?php/* _e( '<h4>Employer Information</h4>', ET_DOMAIN ); */?>  <!--  mene77  -->
			<h3>ایجادشده توسط <a href="<?php echo get_author_posts_url( $convert->post_author ); ?>"><?php the_author_meta( 'display_name', $convert->post_author ); ?></a></h3>
			</br>
