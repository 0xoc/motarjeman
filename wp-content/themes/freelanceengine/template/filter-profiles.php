              ...
              <div class="row">
                  <div class="col-md-4">
                      <div class="fre-input-field">
                          ...
                          <input class="fieldechange keyword search" id="s" type="text" name="s" placeholder="<?php _e('Search freelancers by keyword', ET_DOMAIN);?>">   <!-- mene77  fieldechange -->
                      </div>
                  </div>
                  <div class="col-md-4">
                      <div class="fre-input-field dropdown">
                          <label for="skills" class="fre-field-title"><?php _e('Skills', ET_DOMAIN);?></label>
                          <input id="skills" class="fieldechange dropdown-toggle fre-skill-field" type="text" placeholder="<?php _e ('Search freelancers by skills', ET_DOMAIN ); ?>" data-toggle="dropdown" readonly>  <!-- mene77  fieldechange -->
                            ...
                            <div class="dropdown-menu dropdown-menu-skill">
                              <?php if(count($terms) > 7) : ?>
                                  <div class="search-skill-dropdown">
                                    <input class="fieldechange fre-search-skill-dropdown" type="text">  <!-- mene77  fieldechange -->
                                  </div>
                                <?php endif ?>
                  ...
                  <div class="col-md-4">
                      <div class="fre-input-field">
                          ...
                          <select name="earning" id="total_earning" class="fre-chosen-single">
                              ...
                              <option value="1000000">0 تا 1 میلیون</option>
                              <option value="1000000-5000000">1 میلیون تا 5 میلیون</option>
                              <option value="5000000-10000000">5 میلیون تا 10 میلیون</option>
                              <option value="10000000">بالاتر از 10 میلیون</option>
                          </select>
                      </div>
                  </div>
                  ...
                  <div class="col-md-4">
                      ...
                      <div class="fre-input-field fre-budget-field">
                          ...
                          <span>-</span>
                          <input class="fieldechange filter-budget-max" type="number" name="max_budget" value="<?php echo $max_slider; ?>" min="0">  <!-- mene77  fieldechange -->
