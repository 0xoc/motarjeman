                        ...
                        <div class="step-post-project" id="fre-post-project">
                            ...
                            <div class="fre-input-field">
                                ...
                                <div class="fre-project-budget">
                                    <input id="project-budget" type="number" step="5" required type="number" class="fieldechange input-item text-field is_number numberVal" name="et_budget" min="1"> <!-- mene77  fieldechange -->
                            ...
                            <div class="fre-post-project-btn">
                                <button class="probtnsabt fre-btn fre-post-project-next-btn primary-bg-color" type="submit"><?php _e("Update", ET_DOMAIN); ?></button>
                            </div>
                        </div>
                    </form>
                </div>
