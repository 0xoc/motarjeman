...
if ( ( $payment_type == 'paypaladaptive' || $payment_type == 'frecredit' || $payment_type == 'stripe' ) && ! $order_id ) {
	...
	if ( isset( $ACK ) && $ACK ):
		...
		//fa_v1.8.6.2
		do_action( 'fre_after_process_payment_accept_bid',$bid_id);
                    ...
                    <div class="page-purchase-package-wrap">
                        <div class="fre-purchase-package-box">
                            <div class="step-payment-complete">
                                <!-- add by morteza -->
                                <?php if($payment_return['ACK']==true): ?>
                                ...
                                <?php elseif($payment_return['ACK']==false || $payment_return['ACK']==""): ?>
                                    <h2><?php _e( "Payment failed!", ET_DOMAIN ); ?></h2>
                                    <h2>عنوان خطا:<?php echo $payment_return['msg'] ;?></h2>
                                <?php endif ?>
                                <!-- end add by morteza -->
                                <div class="fre-table">
                                ...
                                <div class="fre-view-project-btn">
                                    ...
                                    <a class="probtnsabt fre-btn"
                                       href="<?php echo $permalink; ?>"><?php _e( "Move now", ET_DOMAIN ); ?></a>      <!--  mene77  -->
                                </div>
                            </div>
                        </div>
                    </div>
...
// change place Down to Up html code by morteza
								...
								if ( isset( $order_data['products'] ) ) {
									...
									switch ( $type ) {
										...
										case 'fre_credit_plan':
											...
											echo "<a class='probtnsabt fre-btn' href='" . $permalink . "'>" . __( 'Click here', ET_DOMAIN ) . "</a>";    /*  mene77  */
											break;
										default:
											...
											if ( $order_data['status'] == 'publish' ) { //Buy package
												...
												echo "<a class='probtnsabt fre-btn' href='" . $permalink . "'>" . __( 'Go', ET_DOMAIN ) . "</a>";    /*  mene77  */
											}
											break;
									}
								}
